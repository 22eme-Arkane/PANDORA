...
class LiveStudioWidget(QWidget):
    ...
    def __init__(self):
        ...
        # ── Bandeau ESTIMATION DE PRIX fixe sous les onglets (parité Cinéma) ──
        # Toujours visible (jamais dans le scroll) : sélection de plans × durée ×
        # grille du DISTRIBUTEUR actif. Alimenté par le signal
        # price_estimate_changed de « Générer depuis Séquences ».
    ...
    def _refresh_price_footer_visibility(self):
        self._price_footer.setVisible(
            ...
            and self.tabs.currentWidget() is self.tab_sequences)
