"""
ui/page_vehicles_live.py — PANDORA | Live : ALIAS SANS DOUBLON.
...
d'en dupliquer ~373 lignes.

⚠ POUR FAIRE DIVERGER LE LIVE (règle d'or de séparation) :
  1. remplacer CE fichier par une copie complète de ui/page_vehicles.py.py ;
...
from ui.page_vehicles import *          # noqa: F401,F403
from ui.page_vehicles import PageVehicles  # noqa: F401  (exports explicites)
