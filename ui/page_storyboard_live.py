...
def _elements_picker_dialog(parent: QWidget, title: str,
    ...
    # la palette système — sombre sur ce fond sombre : le nom de l'élément coché
    # devenait illisible (constat Matthieu 2026-07-25, même défaut qu'en Cinéma).
...
class _MoodBatchDialog(QDialog):
    ...
    def _build_ui(self):
        ...
        # (Pas de réglage d'instant : le Mood rend l'état d'ARRIVÉE pour tous
        # les plans — décision Matthieu 2026-07-28, la doctrine vit dans
        # api.apercu._build_mood_prompt_live.)
