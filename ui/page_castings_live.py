"""
ui/page_castings_live.py — PANDORA | Live : ALIAS SANS DOUBLON.
...
d'en dupliquer ~361 lignes.

⚠ POUR FAIRE DIVERGER LE LIVE (règle d'or de séparation) :
  1. remplacer CE fichier par une copie complète de ui/page_castings.py.py ;
...
from ui.page_castings import *          # noqa: F401,F403
from ui.page_castings import PageCastings  # noqa: F401  (exports explicites)
