"""
ui/tab_history_live.py — PANDORA | Live : ALIAS SANS DOUBLON.
...
d'en dupliquer ~115 lignes.

⚠ POUR FAIRE DIVERGER LE LIVE (règle d'or de séparation) :
  1. remplacer CE fichier par une copie complète de ui/tab_history.py.py ;
...
from ui.tab_history import *          # noqa: F401,F403
from ui.tab_history import TabHistory  # noqa: F401  (exports explicites)
