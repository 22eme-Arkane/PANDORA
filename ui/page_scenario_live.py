...
class PageScenario(QWidget):
    ...
    def _build_right_panel(self):
        ...
        # (Le sélecteur « Génération mapping » a vécu ici quelques heures le
        # 2026-07-30 — Matthieu ne l'y trouvait pas : il vit désormais dans la
        # BARRE de la page Séquence Mapping, à droite du bouton Action.)
