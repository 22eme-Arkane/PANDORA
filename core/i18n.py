...
_FR_TO_EN: dict[str, str] = {
    ...
    "Supprimer le fond de la photo importée ?\n\nRecommandé : l'élément détouré s'intègre mieux aux références envoyées à Seedance.\n(BiRefNet via fal.ai — quelques secondes ; sans clé fal.ai : simulation.)":
        "Remove the background of the imported photo?\n\nRecommended: a cut-out element blends better into the references sent to Seedance.\n(BiRefNet via fal.ai — a few seconds; without a fal.ai key: simulation.)",
    "Photo importée ✓":                          "Photo imported ✓",
    "Erreur BiRefNet":                           "BiRefNet error",
    "Importer une photo de décor":               "Import a set photo",
    "Importer une photo HMC":                    "Import a costume/make-up photo",
    "Importer une photo de véhicule":            "Import a vehicle photo",
    "Utiliser une photo existante du décor plutôt que de le générer":
        "Use an existing photo of the set instead of generating it",
    "Utiliser une photo existante (costume, maquillage, coiffure) plutôt que de générer":
        "Use an existing photo (costume, make-up, hair) instead of generating",
    "Utiliser une photo existante du véhicule plutôt que de le générer":
        "Use an existing photo of the vehicle instead of generating it",
    ...
    "Prompt":                              "Prompt",
    "Prompt (vidéo + son)":                "Prompt (video + sound)",
    "Envoyer le son vers Sound Design (Studio IA)":  "Send the sound to Sound Design (AI Studio)",
    "Vidéo":                               "Video",
    "Son":                                 "Sound",
    ...
    "Ajouter des images d'inspiration (bibliothèque ou fichier, max {n})":
        "Add inspiration images (library or file, max {n})",
    ...
    "Glisse un plan pour le déplacer · clic droit : ajouter / dupliquer / supprimer":
        "Drag a shot to move it · right-click: add / duplicate / delete",
    ...
    "✓  Appliquer ce conducteur au projet": "✓  Apply this rundown",
    ...
    # (Refonte 2026-07-16, maquette validée : une idée par écran — icône
    #  lumineuse, titre, description précise, UN bouton. Vraies captures via
    #  _shot quand assets/onboarding/*.png existent.)
    ...
    "GUIDE DE CONFIGURATION DES SERVICES IA":    "AI SERVICES SETUP GUIDE",
    "FAL.AI · VIDÉOS & IMAGES — 1 SUR 3":        "FAL.AI · VIDEOS & IMAGES — 1 OF 3",
    "FAL.AI · VIDÉOS & IMAGES — 2 SUR 3":        "FAL.AI · VIDEOS & IMAGES — 2 OF 3",
    "FAL.AI · VIDÉOS & IMAGES — 3 SUR 3":        "FAL.AI · VIDEOS & IMAGES — 3 OF 3",
    "CLAUDE · SCÉNARIO & STORYBOARD — 1 SUR 3":  "CLAUDE · SCREENPLAY & STORYBOARD — 1 OF 3",
    "CLAUDE · SCÉNARIO & STORYBOARD — 2 SUR 3":  "CLAUDE · SCREENPLAY & STORYBOARD — 2 OF 3",
    "CLAUDE · SCÉNARIO & STORYBOARD — 3 SUR 3":  "CLAUDE · SCREENPLAY & STORYBOARD — 3 OF 3",
    "DERNIÈRE ÉTAPE":                            "FINAL STEP",
    "Créons ton compte fal.ai":                  "Let's create your fal.ai account",
    "Copie ta clé fal.ai":                       "Copy your fal.ai key",
    ...
    "La clé API est ton <b>badge d'accès personnel</b> : PANDORA l'utilise pour lancer les générations en ton nom.":
        "The API key is your <b>personal access badge</b>: PANDORA uses it to run generations on your behalf.",
    "fal.ai fonctionne <b>à la consommation, sans abonnement</b> : tu ne paies que ce que tu génères.":
    ...
    "Sur la page <b>API Keys</b> : clique <b>« Create Key »</b> → nomme-la <b>PANDORA</b> → <b>« Create Key »</b> → copie la clé <b>sk-ant-…</b>":
        "On the <b>API Keys</b> page: click <b>\"Create Key\"</b> → name it <b>PANDORA</b> → <b>\"Create Key\"</b> → copy the <b>sk-ant-…</b> key",
    "Sur la page <b>Billing</b> : clique <b>« Add to credit balance »</b> — <b>$5</b> suffisent largement : des <b>centaines d'opérations</b> (scénario, storyboard — $0.01 à $0.05 l'opération).":
        "On the <b>Billing</b> page: click <b>\"Add to credit balance\"</b> — <b>$5</b> is more than enough: <b>hundreds of operations</b> (screenplay, storyboard — $0.01 to $0.05 each).",
    "✅  Tu pourras rouvrir ce guide à tout moment depuis <b>Paramètres → Aide API</b>. Et sans clés, PANDORA reste entièrement explorable en mode simulation.":
        "✅  You can reopen this guide at any time from <b>Settings → API Help</b>. And without keys, PANDORA remains fully explorable in simulation mode.",
    "💡  <b>Aucune clé requise pour essayer</b> — PANDORA fonctionne en mode simulation sans clé. Tu peux tout explorer et revenir configurer les clés plus tard depuis <b>Paramètres</b>.":
        "💡  <b>No key required to try</b> — PANDORA runs in simulation mode without keys. You can explore everything and come back to set up the keys later from <b>Settings</b>.",
    "⚠️  La clé ne s'affiche qu'une seule fois — copie-la tout de suite.":
        "⚠️  The key is shown only once — copy it right away.",
    "🔒  Si Claude ne répond pas : désactive ton VPN — certains serveurs VPN sont bloqués par l'API.":
        "🔒  If Claude doesn't respond: disable your VPN — some VPN servers are blocked by the API.",
    "Commencer la configuration →":              "Start the setup →",
    ...
    "Remplace le conducteur de l'éditeur par la version co-écrite avec Claude":
        "Replace the editor's rundown with the co-written version",
    "Copier le scénario remanié dans le presse-papier":
        "Copy the revised screenplay to clipboard",
    "Copier le conducteur remanié dans le presse-papier":
        "Copy the revised rundown to clipboard",
    "✏  Édition manuelle active":   "✏  Manual editing active",
    "✦  Scénario remanié":          "✦  Revised screenplay",
    "✦  Conducteur remanié":        "✦  Revised rundown",
    "Envoyer à Claude  ☁":          "Send to Claude  ☁",
    ...
    # ── Modifier un clip : éditeurs cloud (24/09/2026) ────────────────────────
    "Éditeur vidéo cloud :": "Cloud video editor:",
    "balises @Video1 / @Image1 comprises (comme Seedance)": "@Video1 / @Image1 tags understood (like Seedance)",
    "décrivez la modification en clair (les balises @Video1 sont retirées)": "describe the change plainly (@Video1 tags are removed)",
    "images de référence :": "reference images:",
    "sans image de référence": "no reference image",
    "le clip garde sa durée.": "the clip keeps its duration.",
    "SeedVR2 sur votre GPU  (ComfyUI · 0 $)": "SeedVR2 on your GPU  (ComfyUI · $0)",
    ...
    "'Analyse & co-écriture' ouvre le Studio de co-écriture interactif avec Claude.":
        "'Analysis & co-writing' opens the interactive co-writing Studio with Claude.",
    ...
    "Entrez votre instruction ici…\nEx : « Ne change pas le final de l'acte 2 »":
        "Enter your instruction here…\nEx: 'Don't change the finale of act 2'",
    ...
    "Le conducteur remanié apparaîtra ici après votre première instruction à Claude…\n\nUtilisez la zone de dialogue à droite pour co-écrire avec Claude.": "The reworked rundown will appear here after your first instruction to Claude…\n\nUse the chat area on the right to co-write with Claude.",
    ...
    "💬  Dites à Claude ce que vous voulez changer.\nEx : « Garde l'acte 3 intact », « Rends le drop plus percutant »,\n« Développe la montée de l'acte 2 », « Coupe les stroboscopes »…": "💬  Tell Claude what you want to change.\nE.g.: « Keep act 3 intact », « Make the drop punchier »,\n« Develop the build-up of act 2 », « Cut the strobes »…",
    ...
    "▸ Kling O3 : Pro ($0.112–0.14/s), Standard ($0.084–0.112/s) et 4K (~$0.42/s), T2V + I2V avec image de fin.": "▸ Kling O3: Pro ($0.112–0.14/s), Standard ($0.084–0.112/s) and 4K (~$0.42/s), T2V + I2V with end frame.",
    "▸ Kling v3 Pro : I2V + T2V ($0.112–0.168/s) · Kling v3 4K : T2V ultra-def ($0.28–0.39/s).": "▸ Kling v3 Pro: I2V + T2V ($0.112–0.168/s) · Kling v3 4K: ultra-def T2V ($0.28–0.39/s).",
    "▸ PixVerse v6 : T2V + I2V 360p–1080p, 1 à 15 s, audio optionnel ($0.025–0.115/s).": "▸ PixVerse v6: T2V + I2V 360p–1080p, 1 to 15 s, optional audio ($0.025–0.115/s).",
    "▸ Veo 3.1 : Google, audio natif, 4/6/8 s, 720p → 4K — Pro $0.20–0.60/s · Fast $0.10–0.35/s · Lite $0.03–0.08/s.": "▸ Veo 3.1: Google, native audio, 4/6/8 s, 720p → 4K — Pro $0.20–0.60/s · Fast $0.10–0.35/s · Lite $0.03–0.08/s.",
    "▸ Sora 2 : OpenAI, 4 à 20 s, $0.10/s · Sora 2 Pro : 720p → 1080p natif, $0.30–0.70/s.": "▸ Sora 2: OpenAI, 4 to 20 s, $0.10/s · Sora 2 Pro: 720p → true 1080p, $0.30–0.70/s.",
    "▸ Nouveaux (09/2026) : Wan 3.0 (2-30 s, audio), LTX-2.3 Pro, Gemini Omni Flash 1.1, Grok Imagine 1.5 — T2V + I2V.": "▸ New (09/2026): Wan 3.0 (2-30 s, audio), LTX-2.3 Pro, Gemini Omni Flash 1.1, Grok Imagine 1.5 — T2V + I2V.",
    # Formulaires de l'onglet Moteurs relus le 24/09/2026 (fiches fal).
    "Générer l'audio (facturé en plus)": "Generate audio (billed extra)",
    "LTX-2 · 6 / 8 / 10 s · audio natif": "LTX-2 · 6 / 8 / 10 s · native audio",
    "LTX-2 · image-to-video · 6 / 8 / 10 s": "LTX-2 · image-to-video · 6 / 8 / 10 s",
    "Wan 2.7 · 720p / 1080p · 2-15 s": "Wan 2.7 · 720p / 1080p · 2-15 s",
    "Veo 3.1 · Google · audio natif · 4 / 6 / 8 s · 16:9 ou 9:16": "Veo 3.1 · Google · native audio · 4 / 6 / 8 s · 16:9 or 9:16",
    "Sora 2 · OpenAI · 720p · 4 / 8 / 12 / 16 / 20 s · 16:9 ou 9:16": "Sora 2 · OpenAI · 720p · 4 / 8 / 12 / 16 / 20 s · 16:9 or 9:16",
    "Veo 3.1 · image-to-video · 4 / 6 / 8 s": "Veo 3.1 · image-to-video · 4 / 6 / 8 s",
    "Veo 3.1 Fast · Google · 4 / 6 / 8 s · 16:9 ou 9:16": "Veo 3.1 Fast · Google · 4 / 6 / 8 s · 16:9 or 9:16",
    "Veo 3.1 Fast · image-to-video": "Veo 3.1 Fast · image-to-video",
    "Veo 3.1 Lite · Google · le moins cher des Veo": "Veo 3.1 Lite · Google · the cheapest Veo",
    "Veo 3.1 Lite · image-to-video": "Veo 3.1 Lite · image-to-video",
    "Sora 2 · image-to-video · 4 / 8 / 12 / 16 / 20 s": "Sora 2 · image-to-video · 4 / 8 / 12 / 16 / 20 s",
    "Sora 2 Pro · OpenAI · 4 / 8 / 12 / 16 / 20 s · 16:9 ou 9:16": "Sora 2 Pro · OpenAI · 4 / 8 / 12 / 16 / 20 s · 16:9 or 9:16",
    "Sora 2 Pro · image-to-video": "Sora 2 Pro · image-to-video",
    "Kling O3 Pro · 16:9 · 9:16 · 1:1 · audio en option": "Kling O3 Pro · 16:9 · 9:16 · 1:1 · optional audio",
    "Kling O3 Pro · première / dernière image": "Kling O3 Pro · first / last frame",
    "Kling O3 Standard · le Kling le moins cher": "Kling O3 Standard · the cheapest Kling",
    "Kling O3 Standard · première / dernière image": "Kling O3 Standard · first / last frame",
    "Wan 3.0 · audio natif · plan-séquence jusqu'à 30 s": "Wan 3.0 · native audio · single take up to 30 s",
    "Wan 3.0 · première / dernière image · 2-30 s": "Wan 3.0 · first / last frame · 2-30 s",
    "LTX-2.3 Pro · 6 / 8 / 10 s · 16:9 ou 9:16": "LTX-2.3 Pro · 6 / 8 / 10 s · 16:9 or 9:16",
    "LTX-2.3 Pro · première / dernière image": "LTX-2.3 Pro · first / last frame",
    "Gemini Omni Flash 1.1 · son natif · 16:9 ou 9:16": "Gemini Omni Flash 1.1 · native sound · 16:9 or 9:16",
    "Gemini Omni Flash 1.1 · première / dernière image": "Gemini Omni Flash 1.1 · first / last frame",
    ...
    "♫  Musique": "♫  Music",
    "🎵  Musique": "🎵  Music",
    "Découpage PANDORA (plans)": "PANDORA breakdown (shots)",
    # ── Fiches latérales des pages éléments + états vides (2026-07-23) ──
    "FICHE": "CARD",
    "Sélectionnez un personnage": "Select a character",
    "Sélectionnez un décor": "Select a set",
    "Sélectionnez un accessoire": "Select a prop",
    "Sélectionnez un élément HMC": "Select an HMC item",
    "Sélectionnez un véhicule": "Select a vehicle",
    "plan(s) au storyboard": "shot(s) in the storyboard",
    "séquence(s)": "sequence(s)",
    "Aucun plan au storyboard pour l'instant": "No storyboard shot yet",
    "Aucune description.": "No description.",
    "Aucun décor pour ce projet.": "No set for this project.",
    "Aucun accessoire pour ce projet.": "No prop for this project.",
    "Aucun élément HMC pour ce projet.": "No HMC item for this project.",
    "Aucun véhicule pour ce projet.": "No vehicle for this project.",
    "Aucun personnage ne correspond au filtre.": "No character matches the filter.",
    "Aucun décor ne correspond au filtre.": "No set matches the filter.",
    "Aucun accessoire ne correspond au filtre.": "No prop matches the filter.",
    "Aucun élément HMC ne correspond au filtre.": "No HMC item matches the filter.",
    "Aucun véhicule ne correspond au filtre.": "No vehicle matches the filter.",
    ...
    "Analyse structure + session de co-écriture": "Structure analysis + co-writing session",
    "↻  Relancer l'analyse": "↻  Re-run the analysis",
    "Refait une analyse complète (consomme des crédits API).":
        "Runs a full new analysis (consumes API credits).",
